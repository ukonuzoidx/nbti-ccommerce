          ...
          <div className="hero-slider-wrapper xl:h-full mb-20 xl:mb-0  w-full relative">
            <div className="absolute left-0 top-0 w-full h-full items-center justify-between hidden xl:flex">
              <button
                ...
                className="relative hover:text-qprimary text-[#92D050] 2xl:left-32 left-5 cursor-pointer z-10"
              >
                <svg
              ...
              <button
                ...
                className="relative hover:text-qprimary text-[#92D050]  2xl:right-32 right-5 cursor-pointer z-10"
              >
                <svg
                  width="84"
                  height="68"
                      ...
                      <div className="xl:w-[626px] w-full">
                        ...
                        <Link href="#" passhref>
                          <a rel="noopener noreferrer">
                            <div
                              className={`w-[160px] h-[52px] flex justify-center items-center group rounded bg-qprimary text-white relative transition-all duration-300 ease-in-out overflow-hidden cursor-pointer ${
                                className || ""
                              }`}
                            >
              ...
              <div className="item w-full xl:h-[733px] h-[500px]">
                ...
                >
                  <div className="container-x mx-auto flex items-center  h-full">
                    <div className="w-full h-full xl:flex items-center pt-20 xl:pt-0">
                      <div className="xl:w-[626px] w-full">
                        <p className="md:text-[34px] text-[20px] font-medium text-qprimary mb-[7px]">
                          VR BOX 3D Glass
                        </p>
