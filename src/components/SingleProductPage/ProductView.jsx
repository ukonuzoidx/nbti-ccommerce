...
export default function ProductView({ className, reportHandler }) {
  const productsImg = [
    {
      id: 1,
      src: "cat-home2-06.jpg",
      color: "#FFBC63",
    },
    {
      id: 2,
      src: "img-slider-02-home2.png",
      color: "#649EFF",
    },
    {
      id: 3,
      src: "hover_thum_dgp_61a5d60e2b2d2.jpeg",
      color: "#FFFFFF",
    },
    // {
    //   id: 4,
      ...
      <div data-aos="fade-right" className="lg:w-1/2 xl:mr-[70px] lg:mr-[50px]">
        <div className="w-full">
          <div className="w-full h-[600px] border border-qgray-border flex justify-center items-center overflow-hidden relative mb-3">
            <img src={`/images/${src}`} alt="" className="object-contain" />
            <div className="w-[80px] h-[80px] rounded-full bg-qprimary text-qblack flex justify-center items-center text-xl font-medium absolute left-[30px] top-[30px]">
              <span>-50%</span>
            </div>
          </div>
      ...
      <div className="flex-1">
        <div className="product-details w-full mt-10 lg:mt-0">
          ...
          <div data-aos="fade-up" className="flex space-x-2 items-center mb-7">
            ...
            <span className="text-2xl font-500 text-qred">₦69</span>
          </div>
