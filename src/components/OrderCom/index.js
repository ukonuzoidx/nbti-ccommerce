      ...
      <Layout childrenClasses="pt-0 pb-0">
        <div className="order-tracking-wrapper w-full pt-[60px] pb-[114px]">
          <div className="container-x mx-auto">
            ...
            />
            {resData && (
              <div className="w-full h-[168px]  bg-qpurplelow rounded-2xl mb-10 relative print:hidden">
            ...
            <div className="bg-white lg:p-10 p-3 rounded-xl">
              {resData && (
                <div id="printSection">
                  ...
                  <div className="relative w-full overflow-x-auto overflow-style-none overflow-hidden rounded border border-qpurplelow box-border mb-10">
                            ...
                            >
                              ...
                              <td className=" py-4">
                                <div className="flex justify-center items-center">
                                  <div className="w-[54px] h-[40px] rounded justify-center flex items-center border border-qpurplelow">
                                    <span>{item.qty}</span>
                                  </div>
                                </div>
                              </td>
