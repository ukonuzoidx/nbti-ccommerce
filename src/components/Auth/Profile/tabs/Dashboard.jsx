...
export default function Dashboard({ dashBoardData }) {
  ...
  return (
    <>
      ...
      <div className="quick-view-grid w-full lg:flex justify-between lg:space-x-2 items-center mt-3 ">
        <div className="qv-item xl:w-[298px] xl:h-[208px] lg:w-1/2 w-full mb-5 xl:mb-0 bg-qpurplelow/10 border border-qpurple ransition-all duration-300 ease-in-out p-6 rounded">
          <div className="w-[62px] h-[62px] rounded bg-white flex justify-center items-center text-qpurple">
            <span>
              <svg
                width="36"
                height="37"
              ...
              >
                ...
                <path d="M21.9262 17.5477C26.5907 17.5477 30.3856 13.7528 30.3856 9.08829C30.3856 4.42378 26.5907 0.628906 21.9262 0.628906C17.2616 0.628906 13.4668 4.42378 13.4668 9.08829C13.4668 13.7528 17.2617 17.5477 21.9262 17.5477ZM20.8688 5.91602H22.9836V8.6503L24.7886 10.4554L23.2932 11.9508L20.8687 9.5262V5.91602H20.8688Z" />
              </svg>
            </span>
          </div>
          <p className="text-xl text-qblack mt-5">
            {langCntnt && langCntnt.New_Orders}
          </p>
          <span className="text-[40px] text-qblack font-bold leading-none mt-1 block">
          ...
          <div className="w-[62px] h-[62px] rounded bg-white flex justify-center items-center text-qpurple">
            <span>
              ...
              >
                ...
                <path d="M13.5375 17.9235C11.2244 17.9093 9.35005 16.0112 9.38325 13.7195C9.41763 11.4124 11.3169 9.55701 13.6157 9.58428C15.8849 9.61036 17.7486 11.5013 17.7403 13.7693C17.7332 16.0752 15.8481 17.9378 13.5375 17.9235Z" />
              </svg>
            </span>
          </div>
          <p className="text-xl text-qblack mt-5">
      ...
      <div className="dashboard-info mt-8 lg:flex justify-between items-center bg-[#F8F8F8] rounded xl:p-7 p-5">
        <div className="mb-4 xl:mb-0">
          <h3 className="title text-[22px] font-semibold text-qblack">
            ...
            <table>
              <tbody>
                <tr className="flex mb-5">
                  <td className="text-base text-qgray w-[100px] block capitalize">
        ...
        {dashBoardData.is_seller && (
          <>
            <div className="w-[1px] h-[164px] bg-[#e2adda] lg:block hidden"></div>
