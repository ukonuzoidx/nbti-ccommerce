                ...
                <div className="flex sm:flex-row flex-col-reverse sm:items-center justify-between w-full h-full">
                  ...
                  <div>
                    <div className="flex sm:justify-center justify-start">
                      <div className="w-[170px] h-[170px] rounded-full bg-white mb-[20px] flex justify-center items-center relative">
                        <Image
                          layout="fill"
                          objectFit="scale-down"
                          src={`/assets/images/saller-8.png`}
                          alt=""
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex sm:justify-center justify-start">
                      <div className="w-[170px] h-[170px] rounded-full bg-white mb-[20px] flex justify-center items-center relative">
                        <Image
                          layout="fill"
                          objectFit="scale-down"
                          src={`/assets/images/saller-9.png`}
                          alt=""
                        />
                      </div>
                    </div>
